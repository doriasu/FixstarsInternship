...
#define DCMD_CAMERA_SETRES_CODE 11
#define DCMD_CAMERA_SETRES __DIOT(_DCMD_MISC, DCMD_CAMERA_SETRES_CODE, int)
#define DCMD_CAMERA_GETRES_CODE 12
#define DCMD_CAMERA_GETRES __DIOF(_DCMD_MISC, DCMD_CAMERA_GETRES_CODE, char[256])
#define DCMD_CAMERA_SHOT_CODE 13
#define DCMD_CAMERA_SHOT __DIOT(_DCMD_MISC, DCMD_CAMERA_SHOT_CODE, char[256])
#define DCMD_CAMERA_GETSIZE_CODE 14
#define DCMD_CAMERA_GETSIZE __DIOF(_DCMD_MISC, DCMD_CAMERA_GETSIZE_CODE, uint32_t)
uint8_t (*kaizoudo)[2];
enum KAIZOUDO { CAMERA_RES_160X120=1,CAMERA_RES_176X144,CAMERA_RES_320X240,CAMERA_RES_352X288,CAMERA_RES_640X480,CAMERA_RES_800X600,CAMERA_RES_1024X768,CAMERA_RES_1280X1024,CAMERA_RES_1600X1200 };
char namae[9][21]={ "CAMERA_RES_160X120","CAMERA_RES_176X144","CAMERA_RES_320X240","CAMERA_RES_352X288","CAMERA_RES_640X480","CAMERA_RES_800X600","CAMERA_RES_1024X768","CAMERA_RES_1280X1024","CAMERA_RES_1600X1200" };
